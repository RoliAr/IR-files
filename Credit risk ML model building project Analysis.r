...
source("C:/Users/dalia/Downloads/BabsonAnalytics.R") 
...
df = read.csv("C:/Users/dalia/OneDrive/Desktop/cs-training.csv")
...
df$X = NULL #delete the ID field becaue it have no impact on predictin 
